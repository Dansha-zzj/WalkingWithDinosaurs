describe('Checking expected wot page content', () => {
    ...
    it('Visit the page first and check the title', () => {
        cy.visit('/wot.html')
        cy.title()
            .should('eq', 'climatearchive | Wheel of Time')
    ...
    it('Tooltips pop-up dialogue test', () => {
        ...
        cy.get('.introjs-tooltip-title')
            .should('include.text', 'This is Randland!')
        cy.get('.introjs-tooltiptext')
            .should('include.text', 'The world of The Wheel')
        ...
        cy.get('.introjs-tooltiptext')
            .should('include.text', 'The animation will loop')
        ...
        cy.get('.introjs-tooltiptext')
            .should('include.text', 'Start exploring Randland now')
    ...
    it('Lets check the jet stream layer (200hPa winds)', () => {
        cy.get('.title')
            .eq(3)
